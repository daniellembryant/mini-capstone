User.create!([{
  name: "Johhny Doe", email: "JD@gmail.com", password: "password", password_confirmation: "password"
}, 
{
  name: "Jane Smith", email: "J_S@gmail.com", password: "password", password_confirmation: "password"
}])
